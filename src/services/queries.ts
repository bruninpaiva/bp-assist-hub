...
export const queryKeys = {
  ...
  produtos: (params?: ProdutosListParams) => ["produtos", params ?? {}] as const,
  produto: (id: string) => ["produtos", "detalhe", id] as const,
  categoriasProduto: ["categorias_produto"] as const,
  fornecedores: ["fornecedores"] as const,
  movimentacoes: (produtoId?: string) => ["movimentacoes", produtoId ?? "todos"] as const,
  pecasOs: (osId: string) => ["os_pecas", osId] as const,
